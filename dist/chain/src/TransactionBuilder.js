...
var TransactionBuilder = (function() {
                ...
                _bitsharesjsWs.Apis.instance()
                    ...
                    .then(function(r) {
                        ...
                        if (_this2.expiration === 0)
                            _this2.expiration =
                                base_expiration_sec() +
                                _bitsharesjsWs.ChainConfig.expire_in_secs;
    ...
    */
    ...
    TransactionBuilder.prototype.get_type_operation = function get_type_operation(
        ...
        var operation_id =
            _ChainTypes2.default.operations[_type.operation_name];
        ...
        if (name === "proposal_create") {
            ...
            operation.expiration_time ||
                (operation.expiration_time =
                    base_expiration_sec() +
                    _bitsharesjsWs.ChainConfig.expire_in_secs_proposal);
            if (requiresReview) {
                operation.review_period_seconds =
                    ...
                    Math.max(
                        ...
                        24 * 60 * 60 ||
                            _bitsharesjsWs.ChainConfig.review_in_secs_committee
                    );
                /*
                ...
                reject(
                    new Error(
                        message +
                            ...
                            "bitshares-crypto " +
                            " digest " +
                            _ecc.hash.sha256(_this5.tr_buffer).toString("hex") +
                            " transaction " +
